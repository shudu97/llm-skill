SPINNER_WORDS = [
    ...
    "Beaming", "Beboppin'", "Befuddling", "Billowing", "Blanching", "Bloviating",
    "Boogieing", "Boondoggling", "Booping", "Bootstrapping", "Brewing", "Burrowing",
    ...
    "Fermenting", "Fiddle-faddling", "Finagling", "Flambeing", "Flibbertigibbeting",
    ...
    "Roosting", "Ruminating", "Sauteing", "Scampering", "Schlepping", "Scurrying",
